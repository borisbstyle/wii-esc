...
* Phase A and B sense on ADC5, ADC4; based on tp-18a.     *
***********************************************************
*/

#ifndef TP_NFET_H_INCLUDED
#define TP_NFET_H_INCLUDED
...
#define PORTB_INIT      _BV(AnFET) | _BV(BnFET) | _BV(CnFET)
